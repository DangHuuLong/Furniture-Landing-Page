      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <img
                src="/src/modules/customer/pages/Home/images/Share.png"
                style={{
                  width: '16px',
                  height: '16px',
                }}
            ...
            >
              <img
                src="/src/modules/customer/pages/Home/images/Compare.png"
                style={{
                  width: '16px',
                  height: '16px',
                }}
            ...
            >
              <img
                src="/src/modules/customer/pages/Home/images/Heart.png"
                style={{
                  width: '16px',
                  height: '16px',
                }}
