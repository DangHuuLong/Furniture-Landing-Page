    ...
    <>
      <div style={{
        ...
        <div style={{
          ...
          <img src="./src/modules/customer/pages/Home/images/Meubel House_Logos-05.png" style={{
            width: 50,
            height: 32,
          }}/>
          <p style={{
        ...
        <div style={{
          ...
          <img src="./src/modules/customer/pages/Home/images/mdi_account-alert-outline.png" style={{
            width: 28,
            height: 28,
          }} />
          <img src="./src/modules/customer/pages/Home/images/akar-icons_search.png" style={{
            width: 28,
            height: 28,
          }} />
          <img src="./src/modules/customer/pages/Home/images/akar-icons_heart.png" style={{
            width: 28,
            height: 28,
          }} />
          <button onClick={toggleCart} style={{ background: 'none', border: 'none', padding: 0, cursor: 'pointer' }}>
            <img src="./src/modules/customer/pages/Home/images/ant-design_shopping-cart-outlined.png" style={{
              width: 28,
              height: 28,
            }} />
          </button>
