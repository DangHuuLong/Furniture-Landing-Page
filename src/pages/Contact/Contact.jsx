        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <img src='/src/pages/Contact/images/locate.png' style={{
                width: '22px',
                objectFit: 'cover'
              }}/>
              <div style={{
            ...
            <div style={{
              ...
              <img src='/src/pages/Contact/images/bxs_phone.png' style={{
                width: '30px',
                objectFit: 'cover'
              }} />
              <div style={{
            ...
            <div style={{
              ...
              <img src='/src/pages/Contact/images/bi_clock-fill.png' style={{
                width: '23px',
                objectFit: 'cover'
              }} />
              <div style={{
